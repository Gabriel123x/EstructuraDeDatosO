...
namespace E4_2.AcevedoEnsisoPedroGabriel
{
    class OperacionesNodo//aqui tenemos la clase operaciones nodo donde se realizan las operaciones que necesitaremos para crear nuestros 3 arbioles de ejemplo
    {
        ...
        public void ImprimirE1()
        {
            ...
            Console.WriteLine("El numero de niveles en este arbol es: {0} y su altura es de: {1}", Niveles, Niveles - 1);//imprimimos los niveles que tiene el arbol tambien imprimimos su altura y como la altura comienza a contar desde cero simplemente le restamos uno a los niveles
        ...
        public void ImprimirE2()
        {
            ...
            Console.WriteLine();
            Imprimir(E2,"|");
            Console.WriteLine("El numero de niveles en este arbol es: {0} y su altura es de: {1}", Niveles, Niveles - 1);
            CalcularRuta(E2, "");
